...
object Uris {
    ...
    object Users {
        ...
        const val UPDATE = "/users/{userId}"
        const val DELETE = "/users/{userId}"
    ...
    object Wallets {
         ...
         */
        const val CREATE = "/wallets/users{userId}"

        const val GET_ALL_FROM_USER = "/wallets/users{userId}"
    ...
    object Transactions {
         ...
         */
        const val CREATE = "/transactions/wallets/{walletId}/users/{userId}"
         ...
         */
        const val GET_FROM_WALLET_OF_USER = "/transactions/wallets/{walletId}/users/{userId}"
         ...
         * By category
         */
        const val GET_FROM_ALL_PRIVATE_WALLETS_OF_USER = "/transactions/users/{userId}"
    ...
    object Category {
         ...
         */
        const val CREATE = "/categories/user/{userId}"

        /**
         * Get all system Categories (userId = "system") or all cateogries of a User
         */
        const val GET_CATEGORIES = "/categories/user/{userId}"
