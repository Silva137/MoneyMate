...
function App() {
  ...
  return (
      <div className="min-h-screen bg-gray-100">
          <div className="sidebar min-h-screen w-[4.5rem] overflow-hidden border-r hover:w-56 hover:bg-white hover:shadow-lg">
              <div className="flex h-screen flex-col justify-between pt-2 pb-6">
                  <div>
                      <div className="w-max p-2.5">
                          <img src="https://tailus.io/images/logo.svg" className="w-60" alt=""/>
                      </div>
                      <ul className="mt-8 space-y-6 tracking-wide">
                          <li className="min-w-max">
                              <a href="#" aria-label="dashboard" className="relative flex items-center space-x-10 bg-gradient-to-r from-purple-600 to-cyan-400 px-4 py-3 text-white">
                          ...
                          <li className="min-w-max">
                              <a href="#" className="bg group flex items-center space-x-10 rounded-full px-4 py-3 text-gray-600">
                          ...
                          <li className="min-w-max">
                              <a href="#" className="group flex items-center space-x-10 rounded-md px-4 py-3 text-gray-600">
                                  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" viewBox="0 0 20 20" fill="currentColor">
                  ...
                  <div className="w-max -mb-3">
                      <a href="#" className="group flex items-center space-x-10 rounded-md px-4 py-3 text-gray-600">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 group-hover:fill-cyan-600" viewBox="0 0 20 20" fill="currentColor">
